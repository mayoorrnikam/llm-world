...
| **Verified** | 158 (65%) — every value they assert traced to a primary source |
| **Facts traced to a source** | 190 records carry claim-level evidence |
| **Fully archived** | 220 records where every source has a snapshot |
| **Open weights** | 101 (42%) |
