...
| **Verified** | 113 (61%) — every value they assert traced to a primary source |
| **Facts traced to a source** | 142 records carry claim-level evidence |
| **Fully archived** | 177 records where every source has a snapshot |
| **Open weights** | 77 (41%) |
