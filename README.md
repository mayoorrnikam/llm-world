...
| **Verified** | 151 (62%) — every value they assert traced to a primary source |
| **Facts traced to a source** | 185 records carry claim-level evidence |
| **Fully archived** | 212 records where every source has a snapshot |
| **Open weights** | 101 (42%) |
